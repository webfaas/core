...
describe("Module Manager - requireSync", () => {
    ...
    it("requireSync ./index - 0.0.1", async function(){
        ...
        let responseObj1_a: any = moduleManager1.requireSync("./index.js", "", moduleManagerRequireContextData, parentModuleCompileManifestData);
        chai.expect(responseObj1_a(2,3)).to.eq(5);
        let responseObj1_b: any = moduleManager1.requireSync("./index.js", "0.0.1", moduleManagerRequireContextData, parentModuleCompileManifestData);
        chai.expect(responseObj1_b(2,3)).to.eq(5);

        //
        //moduleManagerRequireContextData_parentnotexist
        //
        let responseObj2_a: any = moduleManager1.requireSync("./index.js", "", moduleManagerRequireContextData_parentnotexist, parentModuleCompileManifestData);
        chai.expect(responseObj2_a).to.null;
        let responseObj2_b: any = moduleManager1.requireSync("./index.js", "0.0.1", moduleManagerRequireContextData_parentnotexist, parentModuleCompileManifestData);
        chai.expect(responseObj2_b).to.null;

        let responseObj3_a: any = moduleManager1.requireSync("./index.js", "", moduleManagerRequireContextData_parentnotexist);
        chai.expect(responseObj3_a).to.null;
        let responseObj3_b: any = moduleManager1.requireSync("./index.js", "0.0.1", moduleManagerRequireContextData_parentnotexist);
    ...
    it("requireSync moduleManager_compilePackageStoreItemBuffer_return_null", async function(){
        ...
        let responseObj9_b: any = moduleManager_compilePackageStoreItemBuffer_return_null.requireSync("./index.js", "0.0.1", moduleManagerRequireContextData, parentModuleCompileManifestData);
