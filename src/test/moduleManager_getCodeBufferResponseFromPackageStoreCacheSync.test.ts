...
describe("Module Manager - getCodeBufferResponseFromPackageStoreCacheSync", () => {
    it("with itemKey", async function(){
        ...
        let resp1 = moduleManager1.getCodeBufferResponseFromPackageStoreCacheSync(packageStoreCacheMemorySync1, packageInfoTarget1, moduleManagerRequireContextData);
        ...
        let resp_notfound = moduleManager1.getCodeBufferResponseFromPackageStoreCacheSync(packageStoreCacheMemorySync1, packageInfoTarget_notfound, moduleManagerRequireContextData);
    ...
    it("without itemKey", async function(){
        ...
        let resp_notfound = moduleManager1.getCodeBufferResponseFromPackageStoreCacheSync(packageStoreCacheMemorySync2, packageInfoTarget1, moduleManagerRequireContextData);
        chai.expect(resp_notfound).to.null;
    })
})